...
<head>
    ...
    <title>Trang chủ - HappyBook</title>
            ...
            <div class="container">
                <section class="row flex">
                    <div class="col-lg-5 col-md-0 col-sm-0 heade__top-left">
                        <span>HappyBook - Cội nguồn của tri thức</span>
                    </div>
                ...
                <section class="row">
                    ...
                    <div class="header__nav col-lg-9 col-md-0 col-sm-0">
                        <ul class="header__nav-list">
                            ...
                            <li class="header__nav-item">
                                <a href="category.html" class="header__nav-link">Sản phẩm</a>
                            </li>
...
<button onclick="topFunction()" id="myBtn-scroll" title="Go to top"><i class="fas fa-chevron-up"></i></i></button>
    ...
    <!-- xổ quảng cáo khi vào trang chủ -->
            ...
            <div class="sale-off">
                <div class="sale-off__container">
                    <h2 class="sale-off__heading">
                        Nhận phiếu giảm giá <span class="sale-off__sp">30%</span>   <br> <span class="sale-off__name">BÙNG NỔ CUỐI NĂM</span> 
                    </h2>
                    ...
                    <a href="product.html" class="sale-off__link">
                        <button class="sale-off__btn">THAM GIA NGAY</button>
                    </a>
                </div>
