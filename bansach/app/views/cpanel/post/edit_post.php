...
<form action="<?php echo BASE_URL ?>/post/update_post/<?php echo $pos['id_post']?>" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <textarea id="editor" name="content_post" style="resize: none;" row="5" class="form-control"> <?php echo $pos['content_post']?></textarea>
  </div>
  <div class="form-group">
    ...
    <?php 
      ...
      ?>
    <option  <?php if($pos['id_category_post']==$cate['id_category_post']) {echo 'selected'  ;} ?> value ="<?php echo 
    $cate['id_category_post']?>"><?php echo $cate['title_category_post']?></option>
    <?php 
      }
      ?>
    </select> 
