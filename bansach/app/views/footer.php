<footer>
            ...
            <div class="bg_in">
               <div class="footer footer_bottom">
                  <div class="footer-col">
                     <h4>Thông tin nhà sách</h4>
                     <div class="footer-col-content">
                        <ul>
                           <li><a href="chitiettin.php">Về chúng tôi</a></li>
                           <li><a href="chitiettin.php">Liên hệ</a></li>
                  ...
                  <div class="footer-col">
                     ...
                     <div class="footer-col-content">
                        <ul>
                           ...
                           <li><a href="chitiettin.php">0000000000000</a></li>
                           <li><a href="chitiettin.php">0000000000000</a></li>
                  ...
                  <div class="footer-col">
                     ...
                     <div class="footer-col-content">
                        <ul class="social">
                        <li><a><i class='fab fa-facebook-square' style='font-size:35px;color:blue'></i> Facebook</a></li>
                        <li><a><i class='fab fa-google' style='font-size:35px;'></i> Google</a></li>
                        </ul>
                        <div class="clear"></div>
                     </div>
                  </div>
                        ...
                        <ul class="icon_list">
                           <li>
                              <a href=".">
                                 ...
                                 <p class="text_li">
                                    <span class="phone_footer">Số điện thoại: (+84) 33-333-3333 </span>
                                    <span class="text_small">(Từ 8h đến 20h tất cả các ngày)</span>
                                 </p>
                              </a>
                           </li>
                           <div class="clear"></div>
                           <li><a><i class="fa fa-envelope" aria-hidden="true"></i>  _______@____________._____</a></li>
                           <li><a><i class="fa fa-mouse-pointer" aria-hidden="true"></i>  http://google.com/</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
               ...
               <div class="footer">
                  ...
                  <div class="footer-col">
                     ...
                     <h4>SINH VIÊN THỰC HIỆN</h4>
                        <address>
                        <address>Họ và tên: Nguyễn Trung Hiếu <br />
                           MSSV: DH51903588<br />
                           Email: DH51903588@student.stu.edu.vn
                        </address>
                        </address>
                  ...
                  <h4>SINH VIÊN THỰC HIỆN</h4>
                        <address>
                        <address>Họ và tên: Nguyễn Thanh Tuấn<br />
                           MSSV: DH51902935<br />
                           Email: DH51902935@student.stu.edu.vn
                        </address>
                        </address>
                     </div>
         ...
         <div class="clear"></div>
         <div class="copyright">
            <h4 class="tkw9999">&copy;  Copyright © 2022 - NHÀ SÁCH HOA BOOK. <a href="http://webextrasite.com/" rel="dofollow" target="_blank">Thiet Ke Web</a> Bởi <a href="https://themeforest.net/">Themeforest.net</a></h4>
         </div>
      </footer>
      <div class="coccoc-alo-phone coccoc-alo-green coccoc-alo-show" id="coccoc-alo-phoneIcon" >
         <a href="tel:090909090" title="">
